...
export declare function httpsGet<T>(url: HttpsOpts, cb: (resolve: (value?: T | PromiseLike<T>) => void, reject: (reason?: any) => void, res: IncomingMessage) => void): Promise<T>;
export declare function httpsGetJson<T>(url: HttpsOpts): Promise<T>;
