...
const winreg_1 = __importDefault(__webpack_require__(5));
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let client;
        let path = yield getRPath(config);
        ...
        const serverOptions = () => new Promise((resolve, reject) => {
            ...
            server.listen(0, '127.0.0.1', () => {
                ...
                const childProcess = child_process_1.spawn(path, Args);
        ...
        let clientOptions = {
            ...
            synchronize: {
                ...
                fileEvents: coc_nvim_1.workspace.createFileSystemWatcher('**/*.r')
            },
            outputChannelName: 'r'
        };
        client = new coc_nvim_1.LanguageClient('r', 'R Language Server', serverOptions, clientOptions);
        client.onReady().then(() => {
            coc_nvim_1.workspace.showMessage('R language server started', 'more');
        }, e => {
            // tslint:disable-next-line:no-console
